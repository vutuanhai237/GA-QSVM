...
from datasets import prepare_cancer_data_holdout
...
# Initialize wandb
wandb.init(project="SVM-PCA", name=f"svm-pca-cancer-holdout-{test_size}-samples")
...
for num_qubits in range(3, max_qubits + 1):
    ...
    for machine_id in range(num_machines):
        ...
        Xw_train, Xw_test, yw_train, yw_test = prepare_cancer_data_holdout(
