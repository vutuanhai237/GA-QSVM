...
from datasets import prepare_wine_data, prepare_mnist_data
from sklearn.model_selection import GridSearchCV
import numpy as np

# Initialize wandb
wandb.init(project="SVM-PCA", name="svm-pca-benchmark-mnist")
...
for num_qubits in range(3, max_qubits + 1):
    ...
    for machine_id in range(num_machines):
        ...
        Xw_train, Xw_test, yw_train, yw_test = prepare_mnist_data(
